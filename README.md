...
![DOT dependency diagram](//pointillism.io/twitter/nodes/src/main/java/com/twitter/nodes_examples/search/graph.dot.png "Rendered Depependency Graph from example code")
